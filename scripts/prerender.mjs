...
const routes = [
  {
    pathname: '/',
    output: 'index.html',
    title: 'Bi Analytic | İş Zekâsı Danışmanlığı',
    description: 'Bi Analytic; veri keşfi, entegrasyon, veri modelleme ve dashboard tasarımı sunan Türkiye merkezli iş zekâsı danışmanlık firmasıdır.',
    ...
    schema: {
      ...
      '@graph': [
        ...
        },
        {
          ...
          '@id': 'https://www.bianalytic.net/#service',
          name: 'Bi Analytic İş Zekâsı Danışmanlığı',
          url: 'https://www.bianalytic.net/',
